 ...
 * Compiled Mon, 31 Jul 2017 18:33:21 UTC
 *
...
var LoaderMiddleware = (function () {
    ...
    Object.defineProperty(LoaderMiddleware, "legacy", {
        set: function (legacy) {
            ...
            var exts = SoundUtils.extensions;
            if (!legacy) {
...
export { filters, htmlaudio, webaudio, sound, SoundUtils as utils, Sound, SoundSprite, Filterable, SoundLibrary };
